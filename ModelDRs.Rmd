...
kable(tfidf.eval.svmlinear) # ~81.56
```
...
# Save 3 Top Models
#### Top Models: dtm.eval.svmradial (82.14%), pca.eval.svmradial (82.10%), lsa.eval.svmlinear (82.08%)
```{r }
# Get models based of of mean F1 score
model1 = model.fit(document_term_matrix, y, 'svmradial')
model2 = model.fit(dtm.pca, y, 'svmradial')
model3 = model.fit(dtm.lsa, y.tfidf, 'svmlinear')
